        ...
        return (
            <header className="sticky top-0 z-50">
                <section className={"w-full py-4 sm:px-12 px-5 flex justify-between duration-[.5s] border-b border-b-black/10 dark:border-b-white/10 focus-within:border-b-black/25 focus-within:dark:border-b-white/25 shadow-xl shadow-black/10 focus-within:sticky max-sm:sticky top-0 z-[200] items-center" + " " + (scrolled ? "sticky focus-within:backdrop-grayscale backdrop-brightness-75 focus-within:backdrop-brightness-100 backdrop-grayscale-0 top-0 bg-white/10 dark:bg-[#161618]/10 focus-within:bg-white/10 focus-within:dark:bg-[#161618]/10 focus-within:backdrop-blur-sm": "bg-white dark:bg-[#161618] relative")}>
                    <Link href={"/"} className="font-bold text-lg uppercase cursor-pointer flex items-center gap-1 relative z-10" >
                        <Image
                            src={"/sly.svg"}
                            alt="Dead Head Ico"
                            height={25}
                    ...
                    <div className={`rounded-lg flex gap-2 ${searchText || placeholder !== "CTRL + K" ? "border-black dark:border-white" : "focus-within:border-black focus-within:dark:border-white"} border-2 border-transparent overflow-hidden px-3 py-2 capitalize relative z-10`}>
                        {loading && <Image
                            src="/spinner.svg"
                            alt="Loading spinner"
                            width={20}
