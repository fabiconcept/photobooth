        ...
        <div className={`popModal p-4 sm:p-[5rem] ${modalShowing ? "in" : "out"}`}>
            <div className="modal">
                <div className="img relative" style={{background: `${avg}`}}>
                    ...
                    <span className="absolute top-3 left-3 cursor-pointer mix-blend-screen w-[30px] h-[30px] flex justify-center items-center bg-white text-2xl rounded-full z-30 max-w-[20rem] text-ellipsis whitespace-nowrap overflow-hidden hover:scale-105 active:scale-95 active:opacity-50 close" onClick={()=>setModalShowing(false)}>x</span>
